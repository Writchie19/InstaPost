...
//                message.setText(R.string.title_notifications)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_IMAGE_OPEN && resultCode == Activity.RESULT_OK) {
            ...
            val imagePath = "users/$currentUserEmail/${file.path}"
    ...
    fun getPosts() {
        ...
        db.collection("posts")
                ...
                .addOnCompleteListener {
                    userposts.postDelayed({loadFrag(postAdapter as RecyclerView.Adapter<RecyclerView.ViewHolder>)}, 1000) // can make the delay an equation based on the number of posts
                }
    }
